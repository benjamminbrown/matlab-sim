...
%   See also power
    if ~(isscalar(A) && isscalar(B))
        ...
        errorID = "rationalFactors:mpower:matrixPowerNotSupported";
        message = "The matrix power method is not supported for nonscalar operands of type 'factors.rationalFactors'.";
